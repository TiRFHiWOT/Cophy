        ...
        <div className="px-6 py-8 border-b border-white/10 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <svg width="32" height="32" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M22 8C18 14 18 30 22 36" stroke="#A66A3F" strokeWidth="2" strokeLinecap="round" fill="none" />
              <line x1="14" y1="22" x2="30" y2="22" stroke="#A66A3F" strokeWidth="2" strokeLinecap="round" opacity="0.7" />
